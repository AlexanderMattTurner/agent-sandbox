...
`_AGENT_SANDBOX_DOCKER_REACHABLE` success cache that `docker_daemon_reachable`
...
def test_clean_success_primes_cache(tmp_path: Path):
    ...
    r = _run(
        ...
        'echo "cache=${_AGENT_SANDBOX_DOCKER_REACHABLE:-unset}"',
        stub,
    )
...
def test_permission_denied_does_not_prime_cache(tmp_path: Path):
    ...
    r = _run(
        ...
        'echo "r1=$r1 r2=$r2 cache=${_AGENT_SANDBOX_DOCKER_REACHABLE:-unset}"',
        stub,
    )
