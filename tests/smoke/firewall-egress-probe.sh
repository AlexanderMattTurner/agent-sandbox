#!/bin/bash
# Runs INSIDE the agent-sandbox firewall image (as root) to prove the egress
...
chmod 644 /usr/share/squid/errors/en/ERR_AGENT_SANDBOX_READONLY
...
echo "agent-sandbox push probe" >"$WORK/file.txt"
